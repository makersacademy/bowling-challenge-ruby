...
RSpec.describe Game do
  context "Separates each game into 10 frames" do 
    it "when no strikes or spares are scored" do
      ...
      expect(game.frames_with_rolls).to eq [[1, 2],[1, 2],[1, 2],[1, 2],[1, 2],[1, 2],[1, 2],[1, 2],[1, 2],[1, 2]]
    end
    ...
    it "Add 3 rolls in frame 10 when strike in frame 10" do
      ...
      strike_frame(game)
      standard_frame(game)
      expect(game.frames_with_rolls).to eq [[1, 2],[1, 2],[1, 2],[1, 2],[1, 2],[1, 2],[1, 2],[1, 2],[1, 2],[10, 1, 2]]
    end
