describe 'playing a whole game' do
  ...
  context 'calculates correct score' do
  ...
  context 'calculates correct score and running total' do
    it 'calulates 300 and running total for a perfect game' do
    ...
    it 'calculates 133 and running total for example game 1' do
    ...
    it 'calculates 176 and running total for example game 2' do
