...
RSpec.describe "it runs the game" do
  ...
  it "returns the score for a game with a spare in 10th frame" do
    frame_1 = Frame.new
    frame_1.add_ball(2)
    frame_1.add_ball(1)
  ...
  it "returns the score for a game with a spare in the 9th and 10th frame" do
    frame_1 = Frame.new
    frame_1.add_ball(2)
    frame_1.add_ball(1)
    ...
    expect(game.total_score).to eq 101
  end

  it "returns the score for a game with a strike in the 9th frame and spare in the 10th frame" do
    frame_1 = Frame.new
    frame_1.add_ball(2)
    frame_1.add_ball(1)
    ...
    expect(game.total_score).to eq 104
  end
end