...
describe ScoreCard do
  ...
  context 'calculating score' do
    describe '#frame_score' do
      ...
      it 'returns "pending" in case of strike' do
        ...
        expect { card.frame_score }.to change { card.total_score[1] }.to('pending')
      end
  ...
  context 'saving frame details with pins by rolls and total score' do
