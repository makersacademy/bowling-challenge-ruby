...
#   def roll(score)
#     if @frame_counter > 10
#       return "you scored #{@game_total}"
#     end
#   p "roll_counter:#{@roll_counter}"

# if @frame_counter == 10 && @roll_counter == 19
#     bonus_points(score)
...
#     return total
#   end
#   if @frame_counter == 10 && @roll_counter == 20
#     if @scorecard[18] == 10
#       @bonus[@frame_counter - 1] += score
#       next_roll
#       return total

#     elsif (@scorecard[18] + @scorecard[19]) == 10
#       bonus_points(score)
#       mark_roll_score(score)
#       add_score_to_frame(score)
#       @strike = false
...
#     end
#   end
#   if @frame_counter == 10 && @roll_counter == 21
#       @bonus[@frame_counter - 1] += score
#       total
#   end
...
#     add_score_to_bonus(score) if @scorecard[@roll_counter - 5] == 10
