...
class Game
    ...
    def previous_frame_but_one_was_a_strike
        not_first_or_second_frame && @all_rolls[-3].length == 1
    end
    ...
    def add_strike_bonus_and_points_to_tally
        if @all_rolls[-2].length == 1 && @tally[-2].empty? && @all_rolls[-1].length == 2 && @all_rolls[-3] != nil && @all_rolls[-3].length != 1
        ...
        elsif @all_rolls[-2].length == 1 && @tally[-2].empty? && @all_rolls[-1].length == 2 && @all_rolls[-3] == nil 
            #if last frame was a strike and two rolls back wasn't a strike and this frame wasn't a strike and it's the second frame 
            @tally[-2] << @all_rolls[-2] << @all_rolls[-1][0] << @all_rolls[-1][1]
        elsif @all_rolls[-3] != nil && @all_rolls[-2].length == 2 && @all_rolls[-3].length == 1 && @tally[-2].empty? && @tally[-3].empty?
        ...
        elsif @all_rolls[-3] != nil && @all_rolls[-3].length != 1 && @all_rolls[-2].length == 1 && @tally[-2].empty? && @all_rolls[-1].length == 1 
            #if last roll was a strike and this roll is a strike and two rolls back was not a strike
        elsif @all_rolls[-3] != nil && @all_rolls[-3].length == 1 && @all_rolls[-2].length == 1 && @tally[-3].empty? && @all_rolls[-1].length == 1
